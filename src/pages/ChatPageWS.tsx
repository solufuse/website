...
const ChatPageWS: React.FC = () => {
    ...
    const handleNewConversation = async () => {
        ...
        if (newChat && currentProject) navigate(`/chats-ws/${currentProject.id}/${newChat.short_id}`);
    };

    const handleConversationSelect = (id: string) => { if (currentProject) navigate(`/chats-ws/${currentProject.id}/${id}`); };
